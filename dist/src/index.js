        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, parser_1.parseWsdl(wsdlPath, mergedOptions)];
                case 1:
                    parsedWsdl = _a.sent();
                    logger_1.Logger.debug("Parser time: " + timer_1.timeElapsed(process.hrtime(timeParseStart)) + "ms");
                    timeGenerateStart = process.hrtime();
                    return [4 /*yield*/, generator_1.generate(parsedWsdl, path_1.default.join(outDir, parsedWsdl.name.toLowerCase()), mergedOptions)];
                case 2:
                    _a.sent();
                    logger_1.Logger.debug("Generator time: " + timer_1.timeElapsed(process.hrtime(timeGenerateStart)) + "ms");
                    logger_1.Logger.info("Generating finished: " + timer_1.timeElapsed(process.hrtime(timeParseStart)) + "ms");
                    return [2 /*return*/];
            }
        });
    });
